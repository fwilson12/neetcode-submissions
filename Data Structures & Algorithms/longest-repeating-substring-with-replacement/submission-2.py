...
class Solution:
    def characterReplacement(self, s: str, k: int) -> int:
        ...
        for R in range(1, len(s)):
            ...
            # while we can't form a consecutive substring with any of the current chars in the window, try the next window. can only use maxfreq, as any freq less will need an even smaller window
